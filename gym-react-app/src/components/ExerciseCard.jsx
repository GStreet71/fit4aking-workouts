  ...
  return (
    ...
    bg-slate-950 sm:flex-wrap'>
        ...
        sm:items-center sm:flex-wrap gap-x-4">
            ...
            md:text-5xl font-semibold text-blue-400">
                0{i + 1}
            </h4>
            <h2 className='capitalize whitespace-nowrap truncate 
            max-w-full text-lg sm:text-xl md:text-2xl flex-1 md:text-center text-yellow-400'>
                {exercise.name.replaceAll("_", " ")}
            </h2>
            <p className="text-sm text-slate-400 capitallize">{exercise.type}</p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
            ...
            <button onClick={ handleSetIncrement }className="flex flex-col p-2 rounded borer-[1.5px] duration-200
            border-solid border-blue-900 hover:border-blue-600 w-full durtion-200">
